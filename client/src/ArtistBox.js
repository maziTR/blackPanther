...
class ArtistBox extends Component {
    ...
    render () {
        return(
            <div className="ArtistBox col-40">
                <img className="main-artist-img" alt="leonard cohen" src={this.state.pic || "http://www.slate.com/content/dam/slate/articles/arts/brow_beat/2016/11/161110_BB_Leonard-Cohen-FB.jpg.CROP.promo-xlarge2.jpg"}></img> 

...
class RelArtist extends React.Component {
    ...
    onPlayClick(){
        console.log("Should play from this.state.audio");
    }
    render() {
        return (
